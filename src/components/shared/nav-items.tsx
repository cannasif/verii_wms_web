    ...
    children: [
      {
        ...
        children: [
          {
            title: 'sidebar.inboundReceiptInvoiceGroup',
            titleFallback: 'Mal Kabul ve Fatura',
            children: [
              {
              ...
              },
              {
                ...
                titleFallback: 'Gelen e-Belgeler',
                children: [
                  { title: 'sidebar.incomingInvoiceArchiveLookup', titleFallback: 'e-Fatura / e-Arşiv Sorgula', href: '/incoming-invoice-archive' },
                  { title: 'sidebar.incomingInvoiceArchiveConnections', titleFallback: 'eLogo Bağlantıları', href: '/incoming-invoice-archive/connections' },
                ],
              },
            ],
          },
          {
            title: 'sidebar.inboundWarehouseReceiptGroup',
            titleFallback: 'Ambar ve Fason Giriş',
            children: [
              {
          ...
          {
            title: 'sidebar.inboundQualityGroup',
            titleFallback: 'Kalite ve Karantina',
            children: [
              {
      ...
      },
      {
        ...
        children: [
          {
            title: 'sidebar.transferWarehouseGroup',
            titleFallback: 'Depolar Arası Transfer',
            children: [
              {
          ...
          {
            title: 'sidebar.transferProductionServiceGroup',
            titleFallback: 'Fason ve Üretim Transferleri',
            children: [
              {
      ...
      },
      {
        ...
        children: [
          {
            title: 'sidebar.outboundShipmentGroup',
            titleFallback: 'Çıkış ve Sevkiyat',
            children: [
              {
          ...
          {
            title: 'sidebar.outboundPackageLoadingGroup',
            titleFallback: 'Paketleme ve Yükleme',
            children: [
              {
                title: 'sidebar.package',
                titleFallback: 'Paket',
                children: [
                  { title: 'sidebar.packageStation', href: '/package/station' },
                  { title: 'sidebar.packageCreate', href: '/package/create' },
                  { title: 'sidebar.packageList', href: '/package/list' },
                  { title: 'sidebar.packageSettings', href: '/package/settings' },
                ],
              },
              { title: 'sidebar.shipmentLoading', titleFallback: 'Staging / Yükleme / Araç', href: '/shipment/loading' },
            ],
          },
        ],
      },
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { title: 'sidebar.bilginogluHakEdisOrderSummaryReport', titleFallback: 'Sipariş Özet Raporu', href: '/service-allocation/bilginoglu-hakedis/order-summary-report' },
