      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            titleFallback: 'Paket',
            children: [
              { title: 'sidebar.packageStation', titleFallback: 'Packing Station', href: '/package/station' },
              ...
              { title: 'sidebar.packageSettings', titleFallback: 'Paketleme Tanımları', href: '/package/settings' },
            ],
          },
        ],
      },
