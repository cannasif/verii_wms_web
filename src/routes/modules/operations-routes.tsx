...
export const operationsChildRoutes: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'collection/:headerId', element: withRoute(TransferCollectionPage, { routeName: 'transfer-collection', namespaces: ['transfer', 'common'] }) },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'collection/:headerId', element: withRoute(ShipmentCollectionPage, { routeName: 'shipment-collection', namespaces: ['shipment', 'common'] }) },
