...
export const erpChildRoutes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: 'kkd/employees', Component: withRoute(KkdEmployeePage, { routeName: 'erp-kkd-employees', namespaces: ['kkd', 'common'] }) },
      { path: 'kkd/departments', Component: withRoute(KkdEmployeeDepartmentPage, { routeName: 'erp-kkd-departments', namespaces: ['kkd', 'common'] }) },
      { path: 'kkd/roles', Component: withRoute(KkdEmployeeRolePage, { routeName: 'erp-kkd-roles', namespaces: ['kkd', 'common'] }) },
      { path: 'kkd/entitlement-matrix', Component: withRoute(KkdEntitlementMatrixPage, { routeName: 'erp-kkd-entitlement-matrix', namespaces: ['kkd', 'common'] }) },
      { path: 'kkd/manual-overrides', Component: withRoute(KkdEntitlementOverridePage, { routeName: 'erp-kkd-manual-overrides', namespaces: ['kkd', 'common'] }) },
