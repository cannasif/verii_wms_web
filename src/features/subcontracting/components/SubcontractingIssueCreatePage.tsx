...
export function SubcontractingIssueCreatePage(): ReactElement {
  ...
  const createMutation = useMutation({
    mutationFn: async (formData: SubcontractingFormData) =>
      createMode === 'order'
        ? subcontractingApi.createSubcontractingIssue(formData, validSelectedItems)
        : subcontractingApi.createStockBasedSubcontractingIssue(formData, validSelectedStockItems),
    onSuccess: () => {
