  ...
  return (
    <Card className={cn('flex flex-col', isOps && 'wms-ops-order-step')}>
      <CardContent className="flex-1 overflow-hidden p-0">
        ...
        <div
          className={cn(
            'hidden lg:flex lg:h-full lg:flex-row',
            isOps ? 'lg:divide-x lg:divide-[color-mix(in_oklab,var(--wms-ops-accent)_18%,var(--wms-ops-card-border))]' : 'lg:divide-x lg:divide-border',
          )}
        >
