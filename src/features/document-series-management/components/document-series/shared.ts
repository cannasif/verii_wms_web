export const documentSeriesOperationTypes = [
  'WI',
  'WO',
  'WT',
  'SH',
...
export function getDocumentSeriesOperationTypeLabel(
  t: (key: string, options?: Record<string, unknown>) => string,
  operationType: string,
): string {
  return t(`documentSeries.operationTypeLabels.${operationType}`, { defaultValue: operationType });
}
