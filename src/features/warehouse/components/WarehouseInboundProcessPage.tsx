...
export function WarehouseInboundProcessPage(): ReactElement {
  ...
  useEffect(() => {
    setPageTitle(t('warehouse.inbound.process.title'));
    return () => {
      setPageTitle(null);
    };
  }, [setPageTitle, t]);
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success(t('warehouse.inbound.process.success'));
      navigate('/warehouse/inbound/list');
    },
    onError: (error: Error) => {
      toast.error(error.message || t('warehouse.inbound.process.error'));
    },
  });
