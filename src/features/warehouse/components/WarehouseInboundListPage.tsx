...
export function WarehouseInboundListPage(): ReactElement {
  ...
  const pageKey = 'warehouse-inbound-list';
  ...
  const getCellText = (row: WarehouseHeader, key: WarehouseInboundColumnKey): string | undefined => {
    switch (key) {
  ...
  return (
    <>
      <OpsListPageShell
        ...
        title={t('warehouse.inbound.list.title')}
        description={t('warehouse.inbound.list.subtitle')}
      >
        ...
        <PagedDataGrid<WarehouseHeader, WarehouseInboundColumnKey>
          variant="ops"
          columns={columns}
          visibleColumnKeys={orderedVisibleColumns.filter((key) => key !== 'actions') as WarehouseInboundColumnKey[]}
          ...
          } as Record<Exclude<WarehouseInboundColumnKey, 'actions'>, React.ReactNode>)[columnKey as Exclude<WarehouseInboundColumnKey, 'actions'>] ?? null}
          ...
          renderActionsCell={(row) => (
            <div className="wms-ops-row-actions">
              ...
              <Button
                ...
                title={t('common.edit')}
                onClick={() => navigate(`/warehouse/inbound/edit/${row.id}`)}
