...
interface WarehouseOrderSelectionPanelProps {
...
export function WarehouseOrderSelectionPanel({
  orders,
  selectedOrderId,
  onSelectOrder,
  isLoading,
            ...
            >
              <div className="flex items-start justify-between gap-1.5 mb-1.5">
                ...
                >
                  {order.remainingForImport > 0
                    ? t('warehouse.step2.pending', 'Beklemede')
                    : t('warehouse.step2.completed', 'Tamamlandı')}
                </Badge>
              </div>
              <div className="flex items-center justify-between text-[10px] text-muted-foreground">
                ...
                <span className="font-medium">
                  {t('warehouse.step2.remaining', 'Kalan')}: {order.remainingForImport.toFixed(2)}
                </span>
              </div>
            </div>
          ))
