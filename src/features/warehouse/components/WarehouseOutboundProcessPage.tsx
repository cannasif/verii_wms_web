...
export function WarehouseOutboundProcessPage(): ReactElement {
  ...
  const createMutation = useMutation({
    mutationFn: async (formData: WarehouseFormData) => warehouseApi.processWarehouseOutbound(formData, validSelectedItems),
    onSuccess: () => {
  ...
  return (
    <Form {...form}>
      <OpsFormPageShell
        ...
        title={t('warehouse.outbound.process.title')}
        description={t('warehouse.outbound.process.subtitle')}
      >
