        ...
        <CardContent className="flex flex-col items-center justify-center py-12">
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              <CardTitle>{t('transfer.step2.noOrderSelected')}</CardTitle>
              <CardDescription>
                {t('transfer.step2.selectOrderPrompt')}
              </CardDescription>
            </div>
          </div>
        </CardContent>
    ...
    <div className="flex flex-col h-full">
      <div className="pb-2 space-y-2 border-b px-2 shrink-0">
        <div className="flex items-center justify-between gap-2">
          <div>
            <h3 className="font-semibold text-sm">{t('transfer.step2.orderContent')}</h3>
            <p className="text-xs text-muted-foreground">
              {t('transfer.step2.itemsCount', { count: totalItems })}
            </p>
          </div>
          <div className="text-right">
            <p className="text-xs text-muted-foreground">{t('transfer.step2.started')}</p>
