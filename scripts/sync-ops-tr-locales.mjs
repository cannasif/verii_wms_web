...
const PKG_TR = {
  ...
  'package.list.createNew': 'Yeni Oluştur',
  ...
  'package.wizard.headerError': 'Başlık kaydedilemedi',
  ...
  'package.wizard.step2.addPackageDescription': 'Yeni paket tanımı ekleyin',
  'package.wizard.step2.noPackages': 'Paket yok',
  'package.wizard.step3.addLine': 'Satır Ekle',
  'package.wizard.step3.addLineDescription': 'Pakete ürün satırı ekleyin',
  'package.wizard.step3.noLines': 'Satır yok',
  'package.wizard.step3.noPackages': 'Paket yok',
  'package.wizard.step3.noPackagesMessage': 'Önce en az bir paket ekleyin',
  'package.wizard.step4.noLines': 'Satır yok',
  'package.wizard.step4.noPackages': 'Paket yok',
};
